...
print('299*299, mixed5 (all trained), no weights, 3 dense layer, dropout, Batch size 20/5, 50 epochs 100 steps, adam, without weights ,optimizers.Adam(lr=0.001, beta_1=0.9, beta_2=0.999, amsgrad=False)')
...
plt.show()
plt.draw()
fig1.savefig('Model_adam.png', dpi=100)
