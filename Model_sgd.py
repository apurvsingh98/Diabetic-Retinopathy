...
print('299*299, mixed5 (all trained), lr=0.01, decay=1e-6, momentum=0.9, nesterov=True ,  0.2 dropout, Batch size 20/5, 50 epochs 100 steps, sgd, without weights ')
...
plt.show()
plt.draw()
fig1.savefig('Model_sgd.png', dpi=100)
